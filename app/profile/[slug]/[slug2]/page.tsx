        ...
        <main className="min-h-[70vh] bg-black text-white">
            ...
            {isLoaded && project && (
                <div className="bg-zinc-900/90 ">
                    ...
                    <section className="max-w-[1440px] mx-auto py-8 md:py-10 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-6 px-5 md:px-8 py-6 md:py-7">
            ...
            <section className="max-w-[1440px] mx-auto py-8 md:py-10">
