                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex gap-16 flex-1 text-lg">
                        ...
                        <div className="flex flex-col gap-4">
                            <h3 className="text-lime flex items-center">
                                April 29 <ArrowDown className="w-4 h-4" />
                            </h3>
                            <div>
                                <p className="text-lime">Public Exhibit</p>
                        ...
                        {/* April 30 */}
                        <div className="flex flex-col gap-4">
                            <h3 className="font-bold text-lime flex items-center">
                                April 30 <ArrowDown className="w-4 h-4" />
                            </h3>
                            <div>
                                <p className="text-lime">YES! Annual Award Show</p>
                    ...
                    {/* Right – map */}
                    <div className="flex flex-col gap-3 lg:w-[420px] text-lg">
