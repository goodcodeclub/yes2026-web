            ...
            <div className="relative bottom-0 w-full px-[16px] lg:px-[48px] bg-black max-w-[1440px]">
                <div className="flex flex-col justify-center self-stretch py-10 mb-10 bg-black lg:max-w-[1440px] lg:flex-row-reverse lg:flex-reverse gap-24 lg:gap-0 lg:mx-auto lg:py-20 lg:mb-20">
                    <div className="w-full z-10 pr-0">
                        <form className="lg:justify-self-end items-start lg:items-end hidden">
                        ...
                        <div className="flex justify-start lg:justify-end lg:pr-[349px] mt-0">
                    ...
                    <div className="lg:w-full">
                        ...
                        <div className="cursor-pointer ff-pack-hard text-3xl text-white flex flex-col leading-none">
                            YES!26
                        </div>
